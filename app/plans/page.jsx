  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {plans.map((plan, index) => (
              <div key={index} className=" text-white border border-gray-800 p-8 hover:border-green-800 transition-colors">
                <h3 className="text-xl text-white font-bold mb-4 text-center">{plan.name}</h3>
                <div className="text-center mb-6 text-white">
                  <span className="text-5xl font-bold text-white">{plan.price}</span>
                </div>
                <p className="text-center mb-3 text-white">{plan.period}</p>
                <p className="text-center mb-8 text-gray-400 h-16 text-white">{plan.details}</p>
      ...
      <section className="py-16 bg-black border-t border-green-800">
        <div className="container mx-auto px-6">
          <h2 className="text-2xl font-bold mb-8 text-cente text-whiter">ADDITIONAL OPTIONS</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="border border-gray-800 p-8 hover:border-green-800 transition-colors">
              ...
              <div className="text-2xl font-bold mb-6 text-white">From £25 per session</div>
              <Link
                href="#contact"
